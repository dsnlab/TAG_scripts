...
rm(ndar_key,ndar_race,ethnicity_long,ndar_ethnicity,together,part3,part2,ndar_subject_df_header,output.df,ndar_subject,ndar_subject_df,ndar_ethnicity.df,participants_ndar_data)
```
...
ndar_ksrq_data <- left_join(KSRQ_Wave1,redcap_cleaned,by="tagid") %>%
  ...
  mutate(interview_date=paste0(sprintf("%02d",month(survey_date)),"/",sprintf("%02d",day(survey_date)),"/",year(survey_date)),
         ...
         ksrq_negsoc=KSRQ_negsoc_mean,
         ksrq_pass=KSRQ_pass_mean,
         ksrq_prosoc=KSRQ_prosoc_mean,
         ksrq_sex=KSRQ_sex_mean,
         ksrq_social=KSRQ_social_mean)
