...
## Save it
write.csv(DSHI_Wave1, file = paste0(workdir,"Questionnaires/Wave_1/DSHI_Wave1.csv"))

## Make RDOC ready file
ndar_dshi_data <- left_join(DSHI_Wave1,redcap_cleaned,by="tagid") %>%
  filter(!is.na(survey_date),!survey_date=="") %>%
  mutate(interview_date=paste0(sprintf("%02d",month(survey_date)),"/",sprintf("%02d",day(survey_date)),"/",year(survey_date)),
         interview_age=round((interval(start =dob, end = survey_date) / duration(num = 1, units = "months")),0),
...
write.table(together,file =paste0(workdir,"RDoCdb/output/may2017/dshi01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
## Save it
write.csv(PANAS_Wave1, file = paste0(workdir,"Questionnaires/Wave_1/PANAS_Wave1.csv"))
...
## Make RDOC ready file
ndar_panas_data <- left_join(PANAS_Wave1,redcap_cleaned,by="tagid") %>%
  filter(!is.na(survey_date),!survey_date=="") %>%
  mutate(interview_date=paste0(sprintf("%02d",month(survey_date)),"/",sprintf("%02d",day(survey_date)),"/",year(survey_date)),
         interview_age=round((interval(start =dob, end = survey_date) / duration(num = 1, units = "months")),0),
         gender="F",
...
write.table(together,file =paste0(workdir,"RDoCdb/output/may2017/panas_c01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
## Save it
write.csv(CBCL_Wave1, file = paste0(workdir,"Questionnaires/Wave_1/CBCL_Wave1.csv"))


## Make RDOC ready file
ndar_cbcl_data <- left_join(CBCL_Wave1,redcap_cleaned,by="tagid") %>%
  filter(!is.na(survey_date),!survey_date=="") %>%
  mutate(interview_date=paste0(sprintf("%02d",month(survey_date)),"/",sprintf("%02d",day(survey_date)),"/",year(survey_date)),
         interview_age=round((interval(start =dob, end = survey_date) / duration(num = 1, units = "months")),0),
         gender="F",
...
write.table(together,file =paste0(workdir,"RDoCdb/output/may2017/cbcl01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
