...
```{r}
survey_date<-filter(cleaned_survey_data, grepl("StartDate",item)) %>%
...
RMET_Wave1<-left_join(RMET,survey_date, by = c("tagid","survey_name")) %>% 
  ...
  mutate(RMET_1_correct=ifelse(RMET_1==1,0,
         ...
         RMET_4_correct=ifelse(RMET_4==1,1,
                               ifelse(RMET_4==2,0,
                                      ifelse(RMET_4==3,0,
                                             ifelse(RMET_4==4,0,NA)))),
         RMET_5_correct=ifelse(RMET_5==1,1,
                               ifelse(RMET_5==2,0,
                                      ifelse(RMET_5==3,0,
                                             ifelse(RMET_5==4,0,NA)))),
         RMET_6_correct=ifelse(RMET_6==1,1,
                               ifelse(RMET_6==2,0,
                                      ifelse(RMET_6==3,0,
                                             ifelse(RMET_6==4,0,NA)))),
         RMET_7_correct=ifelse(RMET_7==1,1,
                               ifelse(RMET_7==2,0,
                                      ifelse(RMET_7==3,0,
         ...
         RMET_9_correct=ifelse(RMET_9==1,1,
                               ifelse(RMET_9==2,0,
                                      ifelse(RMET_9==3,0,
                                             ifelse(RMET_9==4,0,NA)))),
         RMET_10_correct=ifelse(RMET_10==1,1,
                               ifelse(RMET_10==2,0,
                                      ifelse(RMET_10==3,0,
                                             ifelse(RMET_10==4,0,NA)))),
         RMET_11_correct=ifelse(RMET_11==1,1,
                               ifelse(RMET_11==2,0,
                                      ifelse(RMET_11==3,0,
                                             ifelse(RMET_11==4,0,NA)))),
         RMET_12_correct=ifelse(RMET_12==1,1,
                               ifelse(RMET_12==2,0,
                                      ifelse(RMET_12==3,0,
                                             ifelse(RMET_12==4,0,NA)))),
         RMET_13_correct=ifelse(RMET_13==1,1,
                               ifelse(RMET_13==2,0,
                                      ifelse(RMET_13==3,0,
                                             ifelse(RMET_13==4,0,NA)))),
         RMET_14_correct=ifelse(RMET_14==1,1,
                               ifelse(RMET_14==2,0,
                                      ifelse(RMET_14==3,0,
         ...
         RMET_17_correct=ifelse(RMET_17==1,1,
                               ifelse(RMET_17==2,0,
                                      ifelse(RMET_17==3,0,
                                             ifelse(RMET_17==4,0,NA)))),
         RMET_18_correct=ifelse(RMET_18==1,1,
                               ifelse(RMET_18==2,0,
                                      ifelse(RMET_18==3,0,
                                             ifelse(RMET_18==4,0,NA)))),
         RMET_19_correct=ifelse(RMET_19==1,1,
                               ifelse(RMET_19==2,0,
                                      ifelse(RMET_19==3,0,
                                             ifelse(RMET_19==4,0,NA)))),
         RMET_20_correct=ifelse(RMET_20==1,1,
                               ifelse(RMET_20==2,0,
                                      ifelse(RMET_20==3,0,
         ...
         RMET_22_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_23_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_24_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_25_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_26_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_27_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_28_correct=ifelse(RMET_3==1,1,
                               ifelse(RMET_3==2,0,
                                      ifelse(RMET_3==3,0,
                                             ifelse(RMET_3==4,0,NA)))),
         RMET_1_numcompleted=,
...
## Graph it
RMET_Wave1_totals<-RMET_Wave1 %>%
  select(tagid,RMET_total) %>%
  mutate(Perceived_Stress=RMET_total) %>%
  gather('item','value',2:length(.)) %>%
  filter(!grepl("RMET_",item))
RMET_Wave1_totals_graph<-ggplot(RMET_Wave1_totals, aes(x=value, colour=item)) +
  geom_density(alpha=.3)+
  ggtitle(paste0("RMET total score for ",length(unique(RMET_Wave1$tagid[!is.na(RMET_Wave1$RMET_total)]))," participants"))

RMET_Wave1_means<-RMET_Wave1 %>%
  select(tagid,RMET_mean) %>%
  mutate(Perceived_Stress=RMET_mean) %>%
  gather('item','value',2:length(.)) %>%
  filter(!grepl("RMET_",item))
RMET_Wave1_means_graph<-ggplot(RMET_Wave1_means, aes(x=value, colour=item)) +
  geom_density(alpha=.3)+
  ggtitle(paste0("RMET mean score for ",length(unique(RMET_Wave1$tagid[!is.na(RMET_Wave1$tagid)]))," participants"))


## Make RDOC ready file
ndar_rmet_data <- RMET_Wave1 %>%
  filter(!is.na(survey_date),!survey_date=="") %>%
  mutate(interview_date=paste0(sprintf("%02d",month(survey_date)),"/",sprintf("%02d",day(survey_date)),"/",year(survey_date)),
         interview_age=round((interval(start =dob, end = survey_date) / duration(num = 1, units = "months")),0),
         gender="F",
...
ndar_rmet_data <- left_join(ndar_key,ndar_rmet_data, by="tagid") %>%
  ...
  filter(!is.na(subjectkey),
         !interview_age=="") %>%
  select(-contains("RMET",ignore.case = FALSE),-dob,-survey_date,-survey_name,-tagid,-anontagid,-ID,-sa_date,-sb_date,-guid,-survey_type,-qualtrics_date)
rmet_df_header<-rep(NA,length(read.csv(paste0(workdir,"RDoCdb/templates/rmet01_template.csv"), header = FALSE, stringsAsFactors = FALSE)))
rmet_df_header[1]<-read.csv(paste0(workdir,"RDoCdb/templates/rmet01_template.csv"), header = FALSE, stringsAsFactors = FALSE)[1,1]
rmet_df_header[2]<-read.csv(paste0(workdir,"RDoCdb/templates/rmet01_template.csv"), header = FALSE, stringsAsFactors = FALSE)[1,2]

rmet_temp<-as.list(read.csv(paste0(workdir,"RDoCdb/templates/rmet01_template.csv"), header = TRUE, stringsAsFactors = FALSE, skip=1))
...
write.table(together,file =paste0(workdir,"RDoCdb/output/may2017/rmet01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
rm(together,part2,part3,rmet_df_header,rmet_temp,rmet_temp_df,RMET,RMET_Wave1,RMET_Wave1_means,RMET_Wave1_means_graph,
   RMET_Wave1_totals,RMET_Wave1_totals_graph)
```
...
checkoutduplicates<-filter(cleaned_survey_data, grepl(questionnaire,item)) %>% 
  mutate(value=as.numeric(value)) %>%
  filter(!is.na(value)) %>%
  distinct(tagid,item,value,.keep_all = FALSE)
