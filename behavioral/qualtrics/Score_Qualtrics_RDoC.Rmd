...
workdir='/media/casfiles/TAG/behavior/'
```
...
weights_graph<-ggplot(anthro, aes(x=weight)) +
  geom_histogram(alpha=.3)+
  ggtitle(paste0("Weight (kg) for ",length(anthro$weight[!is.na(anthro$weight)])," participants"))+
  facet_grid(~wave)
...
survey_startdate<-filter(cleaned_survey_data, grepl("StartDate",item)) %>%
  ...
  mutate(startdate=as.Date(value),
         survey_type=ifelse(grepl("(Sess 1|W[12]S1)",survey_name),"Sess 1",
                            ifelse(grepl("(Sess 2|W[12]S2)",survey_name),"Sess 2",
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/ndar_subject01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
## Save it
BFI10_Wave1_outdf <- BFI10_Wave1
write.csv(BFI10_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/BFI10_Wave12.csv"))

## Graph it
BFI10_Wave1_totals<-BFI10_Wave1 %>%
  select(tagid,BFI10_neuro_total,BFI10_open_total,BFI10_consc_total,BFI10_agree_total,BFI10_extra_total, survey_date) %>%
  ...
  gather('item','value',-tagid, -survey_date) %>%
  filter(!grepl("BFI10",item))
BFI10_Wave1_totals_graph<-ggplot(BFI10_Wave1_totals, aes(x=value, colour=item)) +
  geom_density(alpha=.3)+
  ggtitle(paste0("BFI total for ",length(BFI10_Wave1_totals$tagid[!is.na(BFI10_Wave1_totals$tagid)])," observations"))


BFI10_change <- BFI10_Wave1 %>%
  select(tagid,BFI10_neuro_total,BFI10_open_total,BFI10_consc_total,BFI10_agree_total,BFI10_extra_total,survey_date) %>%
  mutate(Neuroticism=BFI10_neuro_total,
         Opennes=BFI10_open_total,
         Conscientiousness=BFI10_consc_total,
         ...
         Extraversion=BFI10_extra_total) %>%
  gather('item','value', - tagid, -survey_date) %>%
  mutate(survey_date = as.POSIXct(survey_date)) %>%
  filter(!grepl("BFI10",item)) %>%
  ggplot(aes(x=survey_date, y=value, group=tagid)) +
  geom_line(alpha = .3) +
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/bfi1001.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
## Save it
CAMM_Wave1_outdf <- CAMM_Wave1
write.csv(CAMM_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/CAMM_Wave12.csv"))
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/camm01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.csv(PDS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/PDS_Wave12.csv"))
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/pds01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/tanner_sms01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/caore01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/ces_d01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/crq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/ctq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/dit01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/dshi01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/edinburgh_hand01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/emrq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/ifs01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/iri01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/srq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/mspss01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/pss01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/rmet_cv01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/rscsc01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/sag01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/scared01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/harterac01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/ssds01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/panas_c01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/cbcl01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
