...
DO NOT RUN: This Prepares files used to retrieve GUIDs from NIH
...
# GUID, we can just use that. If it becomes apaprent that they have a mistaken GUID (because last time their
# city of birth was listed as NA which was eroneiously used) then we need to email NDAHelp@mail.nih.gov.
# This happened to me, which is why it's probably important to check current participant info against older
# participant infor in the confidential folder. We still don't have complete info for each participant meaning
...
#
# Anyone without an existing GUID or pseudo-GUID, and who you are not able to generate an new GUID for just gets
...
## Save it
PBIP_Wave1_outdf <- PBIP_Wave1 
write.csv(PBIP_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/PBIP_Wave12.csv"))
...
## Save it
CARE_R_SOC_Wave1_outdf <- CARE_R_SOC_Wave1 
write.csv(CARE_R_SOC_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/CARE_R_SOC_Wave12.csv"))
...
## Save it
CESDC_Wave1_outdf <- CESDC_Wave1 
write.csv(CESDC_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/CESDC_Wave12.csv"))
2
## Graph it
...
## Save it
CRQ_Wave1_outdf <- CRQ_Wave1
write.csv(CRQ_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/CRQ_Wave12.csv"))
...
## Save it
CTQ_Wave1_outdf <- CTQ_Wave1
write.csv(CTQ_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/CTQ_Wave12.csv"))
...
## Save it
write.csv(DIT_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/DIT_Wave12.csv"))
...
write.csv(EHI_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/EHI_Wave12.csv"))
...
## Save it
ERQ_Wave1_outdf <- ERQ_Wave1
write.csv(ERQ_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/ERQ_Wave12.csv"))
...
## Save it
IFS_Wave1_outdf <- IFS_Wave1  
write.csv(IFS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/IFS_Wave12.csv"))
...
## Save it
IRI_Wave1_outdf <- IRI_Wave1 
write.csv(IRI_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/IRI_Wave12.csv"))
...
## Save it
write.csv(KSRQ_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/KSRQ_Wave12.csv"))
...
KSRQ_Wave1_means_graph<-ggplot(KSRQ_Wave1_means, aes(x=as.numeric(value))) +
  geom_density(alpha=.3) +
    facet_wrap(~item) + 
...
## Save it
MSPSS_Wave1_outdf <- MSPSS_Wave1  
write.csv(MSPSS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/MSPSS_Wave12.csv"))
...
## Save it
write.csv(PSS_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/PSS_Wave12.csv"))
...
## Save it
write.csv(RMET_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/RMET_Wave12.csv"))
...
## Save it
write.csv(RSCS_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/RSCS_Wave12.csv"))
...
## Save it
write.csv(SAQ_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/SAQ_Wave12.csv"))
...
## Save it
write.csv(SCARED_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/SCARED_Wave12.csv"))
...
## Save it
write.csv(SCC_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/SCC_Wave12.csv"))
...
## Save it
SPPA_Wave1_outdf <- SPPA_Wave1  
write.csv(SPPA_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/SPPA_Wave12.csv"))
...
## Save it
SSDS_Wave1_outdf <- SSDS_Wave1  
write.csv(SSDS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/SSDS_Wave12.csv"))
...
## Save it
write.csv(PANAS_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/PANAS_Wave12.csv"))
...
## Save it
YRBS_Wave1_outdf <- YRBS_Wave1  
write.csv(YRBS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/YRBS_Wave12.csv"))
...
## Save it
write.csv(CBCL_Wave1, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/CBCL_Wave12.csv"))
...
## Save it
PDS_parent_Wave1_outdf <- PDS_parent_Wave1  
write.csv(PDS_parent_Wave1_outdf, file = paste0(workdir,"Questionnaires/Waves_12_RDOC/PDS_parent_Wave12.csv"))
```
