...
workdir='/Volumes/psych-cog/dsnlab/TAG/behavior/' #"I:/TAG/behavior/" (for Sam)
```
...
credsFile<-file.path(workdir,"Questionnaires/Confidential/credentials.yaml.DEFAULT", fsep="")
...
ndar_key<-left_join(read.csv(file=paste0(workdir,"RDoCdb/confidential/GUID_Batch_201705/GUID_batch_subIDkey.csv"),stringsAsFactors = FALSE),
...
write.csv(BFI10_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/BFI10_Wave1.csv"))
...
write.csv(CAMM_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/CAMM_Wave1.csv"))
...
Menstruation <- read.csv(paste0(workdir,'Puberty/Questionnaires/Puberty_Followup/Menstruation.csv'), header=T)
...
write.csv(CARE_R_SOC_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/CARE_R_SOC_Wave1.csv"))
...
write.csv(CESDC_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/CESDC_Wave1.csv"))
...
write.csv(EHI_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/EHI_Wave1.csv"))
...
write.csv(ERQ_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/ERQ_Wave1.csv"))
...
write.csv(IFS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/IFS_Wave1.csv"))
...
write.csv(IRI_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/IRI_Wave1.csv"))
...
write.csv(MSPSS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/MSPSS_Wave1.csv"))
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2018/scc01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.csv(SPPA_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/SPPA_Wave1.csv"))
...
write.csv(SSDS_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/SSDS_Wave1.csv"))
...
write.csv(CESD_parent_Wave1_outdf, file = paste0(workdir,"Questionnaires/Wave_1/CESD_parent_Wave1.csv"))
