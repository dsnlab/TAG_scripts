...
## Save it
CARE_R_SOC_Wave1_outdf <- CARE_R_SOC_Wave1 %>% filter(!grepl("W2|W3|W4",survey_name)) 
...
write.csv(CARE_R_SOC_Wave4_outdf, file = paste0(workdir,"Questionnaires/Wave4/CARE_R_SOC_Wave4.csv"))
...
CRQ <- left_join(filter(cleaned_survey_data, grepl("CRQ",item)) %>%
                   mutate(value=as.numeric(value)) %>% 
                   filter(!is.na(value)) %>%  
                   filter(!grepl("TAG160",tagid) | grepl("W2|W3|W4",survey_name)) %>% 
...
## Save it
KSRQ_Wave1_outdf <- KSRQ_Wave1 %>% filter(!grepl("W2|W3|W4",survey_name))
...
write.csv(KSRQ_Wave4_outdf, file = paste0(workdir,"Questionnaires/Wave4/KSRQ_Wave4.csv"))
...
## Save it
SPPA_Wave1_outdf <- SPPA_Wave1 %>% filter(!grepl("W2|W3|W4",survey_name)) 
...
write.csv(SPPA_Wave4_outdf, file = paste0(workdir,"Questionnaires/Wave4/SPPA_Wave4.csv"))
...
grid.arrange(SPPA_Wave1_totals_graph, SPPA_Wave2_totals_graph, 
             SPPA_Wave3_totals_graph, SPPA_Wave4_totals_graph, ncol=2)
