...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/camm01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/pds01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/tanner_sms01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
require(gridExtra)
grid.arrange(CESDC_Wave1_totals_graph, CESDC_Wave2_totals_graph, ncol=2)

cesdc_change <- merge(CESDC_Wave1_outdf, CESDC_Wave2_outdf, by = "tagid", all = T)
cesdc_change <- cesdc_change[c("tagid","CES_DC_total.x","CES_DC_total.y")]
cor.test(cesdc_change$CES_DC_total.x, cesdc_change$CES_DC_total.y, use = "pairwise.complete.obs", method = "pearson")
cor.test(cesdc_change$CES_DC_total.x, cesdc_change$CES_DC_total.y, use = "pairwise.complete.obs", method = "spearman")

cesdc_long <- gather(cesdc_change, wave, ces_dc_total, CES_DC_total.x:CES_DC_total.y, factor_key=TRUE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/ces_d01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/crq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/ctq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/dit01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/dshi01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/edinburgh_hand01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/emrq01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/ifs01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
rm(together,part2,part3,ifs_df_header,ifs_temp,ifs_temp_df,IFS,IFS_Wave1_means,IFS_Wave1,IFS_cleaned,IFS_Wave1_totals,IFS_Wave1_totals_graph)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/iri01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/pss01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/rmet_cv01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/rscsc01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/sag01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/scared01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/scc01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
grid.arrange(SPPA_Wave1_totals_graph, SCC_Wave1_total_graph, SPPA_Wave2_totals_graph, SCC_Wave2_total_graph, nrow=2, ncol=2)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/jul2019/harterac01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
...
write.table(together,file =paste0(workdir,"RDoCdb/output/may2019/cbcl01.csv"),sep=",",na = "",row.names=FALSE,col.names=FALSE)
