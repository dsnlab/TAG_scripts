...
replacement <- tibble(tagid = rep("TAG200", 10),
                      survey_name = rep("W2S1 - V1", 10),
                      item = c("PSS_1", "PSS_2", "PSS_3", "PSS_4", "PSS_5", "PSS_6", "PSS_7", "PSS_8", "PSS_9", "PSS_10"), 
                      wave = rep(2, 10),
                      kept_value = c(1, 3, 3, 3, 3, 2, 2, 2, 4, 4))

survey_name = "PSS"


test <- filter(cleaned_survey_data, grepl("^PSS",item)) %>% 
  filter(tagid =="TAG200")


# write a function where for each row of replacement, it goes into the cleaned_survey_data and if there is a matching line, it is replaced. prints total number of successful replacements, writes lines of any unsuccessful replacements
