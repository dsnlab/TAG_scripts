...
# Import the CSV file
tag_age_session <- read.csv(paste0(agedir,'TAG_DOB_SessionDates.csv'))
...
tag_age_session_gathered$wave <- ifelse(tag_age_session_gathered$wave_session 
                                        ...
                                        =="W1S2_Date", 1,
                              ifelse(tag_age_session_gathered$wave_session 
                                        == "W2S1_Date" | 
                                          tag_age_session_gathered$wave_session
                                        =="W2S2_Date", 2, 3))
...
summary_age <- tag_age_session_gathered %>% mutate(tagid = as.factor(tagid)) %>%
