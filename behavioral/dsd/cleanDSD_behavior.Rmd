...
extras <- c(10, 18, 32, 42, 88, 160, 164, 177, 210)
test <- longDF %>% 
...
files <- lapply(X=ids, df=out_df, FUN=function(id, df) {
  ...
  write.table(df, file=paste0(outDataDir,'subjects/Wave3_extra/tag',fid,'_w',chosen_wave,'.csv'),sep=",",row.names=F,col.names=F,na = "")
   })
