...
behavioraldata<-lapply(X=subs,FUN=function(subid){
  if (file.exists(paste0(workdir,"task/output/",subid,"_wave_1_dsd_run1_output.txt")) &
    ...
    subdf<-bind_rows(read.csv(paste0(workdir,"task/output/",subid,"_wave_1_dsd_run1_output.txt")),
  read.csv(paste0(workdir,"task/output/",subid,"_wave_1_dsd_run2_output.txt")))
