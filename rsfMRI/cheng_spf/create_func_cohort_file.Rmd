...
# dataset_orig <- dataset # save a copy of the dataset

for (i in 1:nrow(inclusion_info_three_runs)){ # for every row of the inclusion info three runs df
...
# write.csv(func_cohort, paste0(inclusion_info_dir, "func_cohort_files/func_cohort_tag.csv"))
```
