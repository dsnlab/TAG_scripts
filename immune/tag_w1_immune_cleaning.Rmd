...
if (crp_summary$skew > 2 | crp_summary$skew < -2 | crp_summary$kurtosis > 2 | crp_summary$kurtosis < -2) {
  tag_w1_immune$ln_crp <- as.numeric(lapply(tag_w1_immune$crp_raw, log))
}
if (ifng_summary$skew > 2 | ifng_summary$skew < -2 | ifng_summary$kurtosis > 2 | ifng_summary$kurtosis < -2) {
  tag_w1_immune$ln_ifng <- as.numeric(lapply(tag_w1_immune$ifng_raw, log))
}
if (il10_summary$skew > 2 | il10_summary$skew < -2 | il10_summary$kurtosis > 2 | il10_summary$kurtosis < -2) {
  tag_w1_immune$ln_il10 <- as.numeric(lapply(tag_w1_immune$il10_raw, log))
}
if (il12_summary$skew > 2 | il12_summary$skew < -2 | il12_summary$kurtosis > 2 | il12_summary$kurtosis < -2) {
  tag_w1_immune$ln_il12 <- as.numeric(lapply(tag_w1_immune$il12_raw, log))
}
if (il2_summary$skew > 2 | il2_summary$skew < -2 | il2_summary$kurtosis > 2 | il2_summary$kurtosis < -2) {
  tag_w1_immune$ln_il2 <- as.numeric(lapply(tag_w1_immune$il2_raw, log))
}
if (il4_summary$skew > 2 | il4_summary$skew < -2 | il4_summary$kurtosis > 2 | il4_summary$kurtosis < -2) {
  tag_w1_immune$ln_il4 <- as.numeric(lapply(tag_w1_immune$il4_raw, log))
}
if (il6_summary$skew > 2 | il6_summary$skew < -2 | il6_summary$kurtosis > 2 | il6_summary$kurtosis < -2) {
  tag_w1_immune$ln_il6 <- as.numeric(lapply(tag_w1_immune$il6_raw, log))
}
if (tnfa_summary$skew > 2 | tnfa_summary$skew < -2 | tnfa_summary$kurtosis > 2 | tnfa_summary$kurtosis < -2) {
  tag_w1_immune$ln_tnfa <- as.numeric(lapply(tag_w1_immune$tnfa_raw, log))
}
if (siga_summary$skew > 2 | siga_summary$skew < -2 | siga_summary$kurtosis > 2 | siga_summary$kurtosis < -2) {
  tag_w1_immune$ln_siga <- as.numeric(lapply(tag_w1_immune$siga_frc, log))
}

# Check everything post transformation for any transformed variables 
final_crp_summary <- describe(tag_w1_immune$ln_crp)
final_ifng_summary <- describe(tag_w1_immune$ln_ifng) #better but still above 2 both
final_il10_summary <- describe(tag_w1_immune$ln_il10)
final_il12_summary <- describe(tag_w1_immune$ln_il12) #still shithouse
final_il2_summary <- describe(tag_w1_immune$ln_il2) #better but still above 2 both
final_il4_summary <- describe(tag_w1_immune$ln_il4) # kurtosis still a little above
...
```
In this data, there are 6 IFN-g right outliers, 3 IL-12 right outliers, 5 IL-2 right outliers, 2 IL-4 right outliers, and 1 TNF-a right outlier. Winsorize these values.
```{r}
library(DescTools)
tag_w1_immune$ifng_w <- Winsorize(tag_w1_immune$ln_ifng, minval = ifng_lo_limit, maxval = ifng_up_limit, na.rm = TRUE)
tag_w1_immune$il12_w <- Winsorize(tag_w1_immune$ln_il12, minval = il12_lo_limit, maxval = il12_up_limit, na.rm = TRUE)
tag_w1_immune$il2_w <- Winsorize(tag_w1_immune$ln_il2, minval = il2_lo_limit, maxval = il2_up_limit, na.rm = TRUE)
tag_w1_immune$il4_w <- Winsorize(tag_w1_immune$ln_il4, minval = il4_lo_limit, maxval = il4_up_limit, na.rm = TRUE)
tag_w1_immune$tnfa_w <- Winsorize(tag_w1_immune$ln_tnfa, minval = tnfa_lo_limit, maxval = tnfa_up_limit, na.rm = TRUE)
```
...
tag_w1_immune$il12_cleaned <- tag_w1_immune$il12_w
tag_w1_immune$il2_cleaned <- tag_w1_immune$il2_w
tag_w1_immune$il4_cleaned <- tag_w1_immune$il4_w
tag_w1_immune$il6_cleaned <- tag_w1_immune$ln_il6
tag_w1_immune$tnfa_cleaned <- tag_w1_immune$tnfa_w
