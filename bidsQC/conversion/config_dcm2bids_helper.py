...
dicomdir = os.path.join(os.sep, "projects", group, "shared", study, "archive", "DICOMS")
bidsdir = os.path.join(parentdir, "bids_data") # where the niftis will be put
codedir = os.path.join(parentdir, "bidsQC", "conversion") # Contains subject_list.txt, config file, and dcm2bids_batch.py
...
# Test subject
test_subject = "TAG087_20210622_093059" # Name of a directory that contains DICOMS for one participant
