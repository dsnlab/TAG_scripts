...
rsync -aiv --log-file=$log_name -e ssh jpfeifer@talapas-ln1.uoregon.edu:/projects/dsnlab/shared/tag/fmriprep_20.2.1/fmriprep/* /Volumes/psych-cog/dsnlab/TAG/bids_data/derivatives/fmriprep_20.2.1/fmriprep # fmriprep processed output files from bids_data_sep_wave
