...
```{r, include=FALSE}
redcapData <- read.csv(paste0(cas_dir,'/behavior/Questionnaires/Confidential/MRI_wave1.csv'),header=T)
...
```{r,include=FALSE}
freesurfer <- list.dirs(paste0(cas_dir,'TAG_BIDS/derivatives/freesurfer6'), full.names=FALSE, recursive = FALSE)
...
fmriprep <- list.dirs(paste0(cas_dir,'TAG_BIDS/derivatives/fmriprep'), full.names=FALSE, recursive = FALSE)
