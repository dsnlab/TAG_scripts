...
# Test subject
test_subject = "TAG048_20180702_130143" # Name of a directory that contains DICOMS for one participant
...
singularity_image =  os.path.join(os.sep, "projects", group, "shared", "BIDS", "SingularityContainers", "Dcm2Bids-master.simg")