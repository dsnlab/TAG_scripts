...
###SKEW & KURTOSIS
skew(subset(Hair_long,hormone=="hair_DHEA_pgmg")$concentration,na.rm=T)
skew(subset(Hair_long,hormone=="hair_TEST_pgmg")$concentration,na.rm=T)
skew(subset(Hair_long,hormone=="hair_EST_pgug")$concentration,na.rm=T)
kurtosi(subset(Hair_long,hormone=="hair_DHEA_pgmg")$concentration,na.rm=T)
kurtosi(subset(Hair_long,hormone=="hair_TEST_pgmg")$concentration,na.rm=T)
kurtosi(subset(Hair_long,hormone=="hair_EST_pgug")$concentration,na.rm=T)

###LOG TRANSFORMATION - NOTE FROM HERE ON, "CONCENTRATION_LN" IS LOG TRANSFORMED###
...
#no effects of coloring or perming hair. did not use the "hair treatment" info as girls seem to have interpreted this as straightening or curling their hair on occassion.
```

###SAVE HAIR CONCENTRATIONS
```{r}
Hair_long <- Hair_long %>% select(-colour,-colour_6mn,-perm_6mn)
