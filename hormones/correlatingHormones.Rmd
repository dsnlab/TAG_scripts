...
corplot_shDHEA_men <- ggplot(df_wide, aes(salivaDHEA, hairDHEA, group = menarche)) +
  geom_point(aes(colour = menarche)) +
  #ylim(0,50) + 
  #xlim(1,5) +
  geom_smooth(aes(colour = menarche), method="lm")

corplot_shTEST_men <- ggplot(df_wide, aes(salivaTEST, hairTEST, group = menarche)) +
  geom_point(aes(colour = menarche)) +
  #ylim(0,50) + 
  #xlim(1,5) +
  geom_smooth(aes(colour = menarche), method="lm")

corplot_shEST_men <- ggplot(df_wide, aes(salivaEST, hairEST, group = menarche)) +
  geom_point(aes(colour = menarche)) +
  #ylim(0,50) + 
  #xlim(1,5) +
  geom_smooth(aes(colour = menarche), method="lm")
