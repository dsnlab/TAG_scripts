...
#SBATCH --output=output/DSD_3dMEMA_state_aff_neut.log
#SBATCH --error=output/DSD_3dMEMA_state_aff_neut_err.log
...
cd $rxdir/state_aff_neut

3dMEMA -prefix state_aff_neut -jobs 2       		 		 \
-mask $mask 										 \
-max_zeros 0.25 						 			 \
-HKtest 											 \
-model_outliers 									 \
