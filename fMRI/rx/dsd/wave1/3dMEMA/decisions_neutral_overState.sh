...
#SBATCH --output=output/DSD_3dMEMA_decisionsNeutState_MLmotion_FAST_RT_out.log
#SBATCH --error=output/DSD_3dMEMA_decisionsNeutState_MLmotion_FAST_RT_err.log
...
cd $rxdir/decisions_neutral_overState

3dMEMA -prefix decisions_neutral_overState -jobs 2       		 \
-max_zeros 0.25 						 						 \
-missing_data 0                        							 \
-HKtest 							 							 \
-model_outliers 												 \
-residual_Z            		 				 					 \
-set decision_neutral_overState 								 \
