...
3dLMEr -prefix ResidTiming_changerest_lmer -jobs 8                               \
          ...
          -dataTable @/projects/dsnlab/shared/tag/TAG_scripts/fMRI/rx/svc/long_pub_dep/fulltable_residtiming_changerest.txt \
