...
#--------------------------------------------------------------
#
#SBATCH --job-name=3dICC_motor
#SBATCH --output=output/SVC_icc_runss.log
#SBATCH --error=output/SVC_icc_runss_err.log
...
3dLME -prefix ICC_runs_self -jobs 12                                \
          -model  "Run"										\
		  -ranEff "Subj"				 						\
		  -ICCb													\
          -dataTable @/projects/dsnlab/shared/tag/TAG_scripts/fMRI/rx/svc/long_pub_dep/fulltable_runs_self.txt  \

#-mask /projects/dsnlab/shared/tag/nonbids_data/fMRI/roi/Brainnetome/aligned_opcvisual+tlrc \