...
#SBATCH --output=output/SVC_3dLME_ptim2.log
#SBATCH --error=output/SVC_3dLME_ptim2_err.log
...
3dLMEr -prefix ResidTiming_lmer -jobs 8                               \
          ...
          -dataTable @/projects/dsnlab/shared/tag/TAG_scripts/fMRI/rx/svc/long_pub_dep/fulltable_residtiming.txt \
