...
#--------------------------------------------------------------
#
#SBATCH --job-name=3dlmE_pubsvr
#SBATCH --output=output/SVC_3dLME_pubsvr.log
#SBATCH --error=output/SVC_3dLME_pubsvr_err.log
...
cd $rxdir ; mkdir -p PubComp_selfvsrest ; cd PubComp_selfvsrest/
...
3dLME -prefix PubComp -jobs 8                               \
          ...
          -dataTable @/projects/dsnlab/shared/tag/TAG_scripts/fMRI/rx/svc/long_pub_dep/fulltable_selfvsrest.txt \
