...
matlabbatch{1}.spm.stats.factorial_design.dir = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/rx/svc/wave1/MI/estradiol'};
%%
...
%%
matlabbatch{1}.spm.stats.factorial_design.cov(2).c = [0.806699055
-0.210721031
0.346068898
0.217929984
0.116003676
...
matlabbatch{1}.spm.stats.factorial_design.cov(2).cname = 'estradiol';
