...
matlabbatch{1}.spm.stats.factorial_design.dir = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/rx/svc/wave1/MI/pds_noage'};
%%
...
%%
matlabbatch{1}.spm.stats.factorial_design.cov(1).c = [2.5
2.5
2.5
3.5
2
...
matlabbatch{1}.spm.stats.factorial_design.cov(1).cname = 'pds';
