%-----------------------------------------------------------------------
% Job saved on 31-May-2021 17:11:08 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.util.exp_frames.files = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/fmriprep/sub-TAG001w02/ses-wave2/func/s2_sub-TAG001w02_ses-wave2_task-DSD_run-1_space-MNI152NLin2009cAsym_desc-preproc_bold.nii,1'};
matlabbatch{1}.spm.util.exp_frames.frames = Inf;
matlabbatch{2}.spm.util.exp_frames.files = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/fmriprep/sub-TAG001w02/ses-wave2/func/s2_sub-TAG001w02_ses-wave2_task-DSD_run-2_space-MNI152NLin2009cAsym_desc-preproc_bold.nii,1'};
matlabbatch{2}.spm.util.exp_frames.frames = Inf;
matlabbatch{3}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/fmriprep/sub-TAG001w02/ses-wave2/func/sub-TAG001w02_ses-wave2_task-DSD_run-1_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz'};
...
matlabbatch{4}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/models/dsd/waves123/betaseries/sub-TAG001w02'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w02_DSD1_disc_betaseries_NOD.mat'};
matlabbatch{4}.spm.stats.fmri_spec.sess(1).regress = struct('name', {}, 'val', {});
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/auto-motion-fmriprep/rp_txt/rp_sub-TAG001w02_DSD1.txt'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w02_DSD2_disc_betaseries_NOD.mat'};
matlabbatch{4}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/auto-motion-fmriprep/rp_txt/rp_sub-TAG001w02_DSD2.txt'};
