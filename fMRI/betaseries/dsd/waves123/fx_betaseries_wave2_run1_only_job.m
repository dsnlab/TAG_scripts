%-----------------------------------------------------------------------
% Job saved on 31-May-2021 17:05:52 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
...
matlabbatch{2}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/fmriprep/sub-TAG001w02/ses-wave2/func/sub-TAG001w02_ses-wave2_task-DSD_run-1_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz'};
...
matlabbatch{3}.spm.stats.fmri_spec.sess.multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w02_DSD1_disc_betaseries_NOD.mat'};
matlabbatch{3}.spm.stats.fmri_spec.sess.regress = struct('name', {}, 'val', {});
matlabbatch{3}.spm.stats.fmri_spec.sess.multi_reg = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/auto-motion-fmriprep/rp_txt/rp_sub-TAG001w02_DSD1.txt'};
