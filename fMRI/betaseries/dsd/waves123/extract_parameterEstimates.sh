...
# ------------------------------------------------------------------------------------------
# variables
rois=(inflated_2_seed_vmPFC_vox200 NAcc)
...
# paths
beta_dir=/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/models/dsd/waves123/betaseries/sub-"${SUB}" #beta directory
roi_dir=/projects/dsnlab/shared/tag/nonbids_data/fMRI/roi/cheng_spf  #roi directory 
output_dir=/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/models/dsd/waves123/betaseries/parameterEstimates #parameter estimate output directory
