%-----------------------------------------------------------------------
% Job saved on 31-May-2021 11:43:08 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w01_DSD1_disc.betaseries_NOD.mat'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w01_DSD2_disc.betaseries_NOD.mat'};
