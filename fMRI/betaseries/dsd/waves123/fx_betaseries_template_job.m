%-----------------------------------------------------------------------
% Job saved on 31-May-2021 11:45:54 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
...
matlabbatch{4}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/models/dsd/waves123/betaseries/sub-TAG001w01'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w01_DSD1_disc_betaseries_NOD.mat'};
matlabbatch{4}.spm.stats.fmri_spec.sess(1).regress = struct('name', {}, 'val', {});
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/auto-motion-fmriprep/rp_txt/rp_sub-TAG001w01_DSD1.txt'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/dsd/waves123/betaseries_disclosure/TAG001w01_DSD2_disc_betaseries_NOD.mat'};
matlabbatch{4}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/dsnlab/shared/tag/fmriprep_20.2.1/auto-motion-fmriprep/rp_txt/rp_sub-TAG001w01_DSD2.txt'};
