...
matlabbatch{2}.spm.util.exp_frames.files = {'/projects/dsnlab/shared/tag/fmriprep_1.5.2/wave2/fmriprep/sub-TAG001/ses-wave2/func/s6_sub-TAG001_ses-wave2_task-SVC_run-02_space-MNI152NLin2009cAsym_desc-preproc_bold.nii,1'};
matlabbatch{2}.spm.util.exp_frames.frames = Inf;
matlabbatch{3}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files = {'/projects/dsnlab/shared/tag/fmriprep_1.5.2/wave2/fmriprep/sub-TAG001/ses-wave2/func/sub-TAG001_ses-wave2_task-SVC_run-01_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz'};
...
matlabbatch{4}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/models/svc/wave1and2/betaseries/wave2/sub-TAG001'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/svc/betaseries_2waves/TAG001_wave2_SVC1.mat'};
matlabbatch{4}.spm.stats.fmri_spec.sess(1).regress = struct('name', {}, 'val', {});
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/wave1and2/auto-motion-fmriprep/rp_txt/rp_TAG001_2_SVC_1.txt'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/multiconds/svc/betaseries_2waves/TAG001_wave2_SVC2.mat'};
matlabbatch{4}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/wave1and2/auto-motion-fmriprep/rp_txt/rp_TAG001_2_SVC_2.txt'};
