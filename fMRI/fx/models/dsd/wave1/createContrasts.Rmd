...
contrasts <- c("affect_state","neutral_state","affect_decision","neutral_decision","affect_value_pmod","neutral_value_pmod","affect_dec_pmod","neutral_dec_pmod","missing")

for (i in 3:length(contrasts)) {
