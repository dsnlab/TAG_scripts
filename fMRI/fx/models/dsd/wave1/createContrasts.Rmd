...
out_dir <- '/Volumes/StorEDGE/WORK/DSN/TAG/TAG_scripts/fMRI/fx/models/dsd/wave1/contrasts/2x2/fd0.8dv2.0/'
```
...
%-----------------------------------------------------------------------")
cat("\n")
cat("matlabbatch{1}.spm.stats.con.spmmat = {'/Volumes/psych-cog/dsnlab/TAG/nonbids_data/fMRI/fx/models/dsd/wave1/fd0.7_N/pmod/sub-TAG",fid,"/SPM.mat'};",sep="")
cat("\n")
for(i in 1:length(df)){
cat("matlabbatch{1}.spm.stats.con.consess{",i,"}.tcon.name = '", colnames(df)[i],"';", sep="")
cat("\n")
