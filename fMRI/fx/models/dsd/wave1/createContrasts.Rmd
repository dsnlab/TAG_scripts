...
# directory to save output. make sure folder is created.
out_dir <- '/Volumes/StorEDGE/WORK/DSN/TAG/TAG_scripts/fMRI/fx/models/dsd/wave1/contrasts/pmod/MLmotion_AR_nomask/'
```
...
%-----------------------------------------------------------------------")
cat("\n")
cat("matlabbatch{1}.spm.stats.con.spmmat = {'/Volumes/psych-cog/dsnlab/TAG/nonbids_data/fMRI/fx/models/dsd/wave1/pmod/MLmotion_AR_nomask/sub-TAG",fid,"/SPM.mat'};",sep="")
cat("\n")
for(i in 1:length(df)){
cat("matlabbatch{1}.spm.stats.con.consess{",i,"}.tcon.name = '", colnames(df)[i],"';", sep="")
cat("\n")
...
neutral_dec_pmod_list <- as.character(paste0(neutral_dec_pmod$id,'_',neutral_dec_pmod$number))
