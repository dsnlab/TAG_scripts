...
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.name = 'sub-TAG001/ML';
...
matlabbatch{10}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/svc_flux_auto-motion/rp_txt/rp_TAG001_SVC1_ML.txt'};
...
matlabbatch{10}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/svc_flux_auto-motion/rp_txt/rp_TAG001_SVC2_ML.txt'};
