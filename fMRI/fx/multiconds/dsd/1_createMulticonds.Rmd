...
#affect statement=1, neutral statement=2, affect_share==3, neutral_share=4, affect_private==5, neutral_private==6
...
comp_DF <- multicondsDF %>% select(sid,run,name,onset,duration,pmod) %>%
...
#Of the final list, create a document outlining what conditions each subject has
```{r}
...
summary_bySubj <- summary_DF %>% spread(key=name,value=N)
write.csv(summary_bySubj, '~/Desktop/dsd_summary_bySubj.csv',row.names=F)

binary_bySubj <- summary_DF %>% mutate(N = ifelse(N > 0, 1, 0)) %>%
  spread(key=name,value=N) %>%
  arrange(cond_3,cond_4,cond_5,cond_6,cond_7) %>%
  mutate(multicond = ifelse((cond_3==1 & cond_4==1 & cond_5==1 & cond_6==1 & cond_7==1),1,
                     ifelse((cond_3==1 & cond_4==1 & cond_5==1 & cond_6==1 & cond_7==0),2,
                     ifelse((cond_3==1 & cond_4==1 & cond_5==1 & cond_6==0 & cond_7==1),3,
                     ifelse((cond_3==1 & cond_4==1 & cond_5==1 & cond_6==0 & cond_7==0),4,
                     ifelse((cond_3==1 & cond_4==1 & cond_5==0 & cond_6==1 & cond_7==1),5,
                     ifelse((cond_3==1 & cond_4==1 & cond_5==0 & cond_6==1 & cond_7==0),6,
                     ifelse((cond_3==1 & cond_4==1 & cond_5==0 & cond_6==0 & cond_7==1),7,       
                     ifelse((cond_3==1 & cond_4==1 & cond_5==0 & cond_6==0 & cond_7==0),8,
                     ifelse((cond_3==1 & cond_4==0 & cond_5==1 & cond_6==1 & cond_7==1),9,
                     ifelse((cond_3==0 & cond_4==1 & cond_5==1 & cond_6==1 & cond_7==1),10,
                            NA)))))))))))
...
write.csv(binary_bySubj, '~/Desktop/dsd_binary_bySubj.csv',row.names=F)

```

#Check how many subjects differ in multiconds between run 1 and run 2 - for creating contrasts.
```{r}
con_bySubj <- binary_bySubj %>% arrange(sid,run) %>% group_by(sid) %>%
