...
# paths
confoundDir = '/projects/dsnlab/shared/tag/fmriprep_1.5.2/wave2/fmriprep'
summaryDir = '/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/wave1and2/auto-motion-fmriprep/summary'
plotDir = '/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/wave1and2/auto-motion-fmriprep/plots'
rpDir = '/projects/dsnlab/shared/tag/nonbids_data/fMRI/fx/motion/wave1and2/auto-motion-fmriprep/rp_txt'

# variables
study = 'TAG'
subPattern = 'sub-(.*[0-9]{3})'
wavePattern = 'ses-wave([0-9]{1})'
taskPattern = 'task-(SVC)'
